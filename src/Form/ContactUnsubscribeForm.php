 ...
 */
class ContactUnsubscribeForm extends ConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to unsubscribe @user from the %account account?', [
  ...
  public function getFormId() {
    return 'contact_unsubscribe_form';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message($this->t('Contact: %name has been unsubscribed.', ['%name' => $this->contact->email_addresses[0]->email_address]));
